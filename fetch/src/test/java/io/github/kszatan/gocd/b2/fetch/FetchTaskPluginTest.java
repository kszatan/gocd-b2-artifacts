...
public class FetchTaskPluginTest {
    private FetchTaskPlugin plugin;
    ...
    public void setUp() throws Exception {
        ...
        plugin = new FetchTaskPlugin(requestHandlerFactory);
    ...
    public void pluginIdentifierShouldReturnCorrectPluginInfo() {
        FetchTaskPlugin plugin = new FetchTaskPlugin();
