...
import io.github.kszatan.gocd.b2.fetch.handlers.bodies.ConfigurationDefinition;
...
public class ConfigurationRequestHandlerTest {
    ...
    public void handleShouldReturnValidConfiguration() throws Exception {
        ...
        assertThat(definition.repositoryName, notNullValue());
        assertThat(definition.packageName, notNullValue());
        assertThat(definition.destination, notNullValue());
    }
