...
package io.github.kszatan.gocd.b2.fetch;
...
import io.github.kszatan.gocd.b2.fetch.handlers.DefaultRequestHandlerFactory;
import io.github.kszatan.gocd.b2.fetch.handlers.RequestHandler;
import io.github.kszatan.gocd.b2.fetch.handlers.RequestHandlerFactory;

import java.util.Collections;
import java.util.List;

@Extension
public class FetchTaskPlugin extends AbstractGoPlugin {
    ...
    private Logger logger = Logger.getLoggerFor(FetchTaskPlugin.class);

    public FetchTaskPlugin() {
        requestHandlerFactory = new DefaultRequestHandlerFactory();
    }

    public FetchTaskPlugin(RequestHandlerFactory requestHandlerFactory) {
